...
public class IncomingCallNotificationService extends Service {
    ...
    private Notification createNotification(CallInvite callInvite, int notificationId, int channelImportance) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(this, notificationId, intent, PendingIntent.FLAG_MUTABLE | PendingIntent.FLAG_IMMUTABLE);
        /*
    ...
    private Notification buildNotification(String title, String text, PendingIntent pendingIntent, Bundle extras,
       ...
       PendingIntent piRejectIntent = PendingIntent.getService(getApplicationContext(), 0, rejectIntent, PendingIntent.FLAG_MUTABLE | PendingIntent.FLAG_IMMUTABLE);
        ...
        PendingIntent piAcceptIntent = PendingIntent.getService(getApplicationContext(), 0, acceptIntent, PendingIntent.FLAG_MUTABLE | PendingIntent.FLAG_IMMUTABLE);
    ...
    private void buildMissedCallNotification(String callerId, String to, boolean showReturnCallOption) {
        ...
        /////////////
        PendingIntent piReturnCallIntent = PendingIntent.getService(getApplicationContext(), 0, returnCallIntent,PendingIntent.FLAG_MUTABLE | PendingIntent.FLAG_IMMUTABLE);
